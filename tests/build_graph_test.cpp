...
TEST(BuildNodeTest, ConstructorInitializesProperties) {
  BuildNode node("//src:test", "cc_library", {"file1.cpp", "file2.cpp"}, {"libtest.a"},
                 {{"visibility", "public"}});
...
TEST(BuildNodeTest, GetAttributeReturnsCorrectValue) {
  BuildNode node("//src:test", "cc_library", {}, {},
...
TEST(BuildNodeTest, ComputeHashIsDeterministic) {
  BuildNode node1("//src:test", "cc_library", {"file1.cpp"}, {"libtest.a"}, {{"key", "value"}});

  BuildNode node2("//src:test", "cc_library", {"file1.cpp"}, {"libtest.a"}, {{"key", "value"}});

  EXPECT_EQ(node1.compute_hash(), node2.compute_hash());
}

TEST(BuildNodeTest, EqualityOperator) {
  BuildNode node1("//src:test", "cc_library", {"file1.cpp"}, {"libtest.a"}, {});

  BuildNode node2("//src:test", "cc_library", {"file1.cpp"}, {"libtest.a"}, {});

  BuildNode node3("//src:different", "cc_library", {"file1.cpp"}, {"libtest.a"}, {});
...
TEST(BuildGraphTest, BuilderAddsNodesSuccessfully) {
  ...
  auto result =
      builder.add_node(BuildNode("//src:lib", "cc_library", {"lib.cpp"}, {"liblib.a"}, {}));
...
TEST(BuildGraphTest, BuilderRejectsNodeAlreadyExists) {
  ...
  auto result =
      builder.add_node(BuildNode("//src:lib", "cc_library", {"other.cpp"}, {"other.a"}, {}));
...
TEST(BuildGraphTest, TopologicalSortProducesValidOrder) {
  ...
  EXPECT_LT(std::distance(order.begin(), lib2_pos), std::distance(order.begin(), lib1_pos));
  EXPECT_LT(std::distance(order.begin(), lib1_pos), std::distance(order.begin(), app_pos));
}
