...
public:
    ...
    private:
        ...
        [[nodiscard]] auto would_create_cycle(const std::string& from, const std::string& to) const -> bool;

        /// @brief Depth-first search for cycle detection
        auto dfs_cycle_check(const Label& node, 
    ...
    [[nodiscard]] static auto builder() -> Builder { return Builder{}; }
...
private:
    ...
    auto topological_sort_dfs(const Label& node,
                            std::unordered_set<Label>& visited,
