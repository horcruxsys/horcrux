...
public:
  ...
  [[nodiscard]] auto
  get_dependencies(const Label& label) const -> tl::expected<std::vector<Label>, GraphError>;
  ...
  [[nodiscard]] auto
  get_dependents(const Label& label) const -> tl::expected<std::vector<Label>, GraphError>;
