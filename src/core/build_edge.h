...
public:
  ...
  BuildEdge(std::string from_label, std::string to_label,
  ...
  [[nodiscard]] auto from() const -> const std::string& {
    return from_label_;
  }

  /// @brief Get the target node label
  /// @return The to label
  [[nodiscard]] auto to() const -> const std::string& {
    return to_label_;
  }

  /// @brief Get the dependency type
  /// @return The dependency type
  [[nodiscard]] auto dependency_type() const -> DependencyType {
    return dep_type_;
  }
