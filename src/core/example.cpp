...
auto main() -> int {
  ...
  builder.add_node(BuildNode("//src:app", "cc_binary", {"main.cpp", "app.cpp"}, {"bin/app"},
                             {{"compiler", "g++"}, {"optimization", "O2"}}));

  builder.add_node(BuildNode("//src:lib1", "cc_library", {"lib1.cpp", "lib1.h"}, {"lib/liblib1.a"},
                             {{"visibility", "public"}}));

  builder.add_node(BuildNode("//src:lib2", "cc_library", {"lib2.cpp", "lib2.h"}, {"lib/liblib2.a"},
                             {{"visibility", "public"}}));

  builder.add_node(BuildNode("//src:lib3", "cc_library", {"lib3.cpp", "lib3.h"}, {"lib/liblib3.a"},
                             {{"visibility", "private"}}));
  ...
  if (!cycle_result) {
    std::cout << "   ✓ Cycle detected and prevented: " << to_string(cycle_result.error()) << "\n\n";
  }
