...
auto BuildGraph::Builder::would_create_cycle(const std::string& from, const std::string& to) const -> bool {
...
auto BuildGraph::Builder::dfs_cycle_check(const Label& node,
                                         std::unordered_set<Label>& visited,
...
auto BuildGraph::topological_sort_dfs(const Label& node,
                                     std::unordered_set<Label>& visited,
